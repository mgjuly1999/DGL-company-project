...
<!-- Sparkline -->
<script src="<c:url value="/assets/template/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"/>"></script>
<!-- jvectormap  -->
<script src="<c:url value="/assets/template/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"/>"></script>
<script src="<c:url value="/assets/template/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"/>"></script>
<!-- SlimScroll -->
<script src="<c:url value="/assets/template/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"/>"></script>
<!-- ChartJS -->
<script src="<c:url value="/assets/template/bower_components/chart.js/Chart.js"/>"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<c:url value="/assets/template/dist/js/pages/dashboard2.js"/>"></script>
