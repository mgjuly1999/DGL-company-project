...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Admin</b>DGL</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

  <form:form action="adminLoginPath"  modelAttribute="frmLogin"  method="POST"  >
      <div class="form-group has-feedback">
        <form:input type="email"  class="form-control"  id="mail" name="mail" path="mail" placeholder="Email" required="autofocus"/>
      
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
       <form:input type="password" class="form-control"  id="pwd" name="password" path="pwd" placeholder="Password" required="required"/>
    ...
    <a href="adminRegisterOuterPath" class="text-center">Register a new membership</a>
...
<!-- iCheck -->
<script src="<c:url value="/assets/template//assets/template/plugins/iCheck/icheck.min.js"/>"></script>
<script>
  $(function () {
    $('input').iCheck({
