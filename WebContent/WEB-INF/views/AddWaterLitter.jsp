 ...
 <header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
    To Add Water Litters For Customer ${waterLitterForm.customer.name} 
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">To Add  ${addWaterLitterForm.address.address} Customer Water Litters</a></li>
        <li class="active"> To Add Customer ${addWaterLitterForm.customer.name} Water Litters</li>
      </ol>
    </section>
    ...
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-20">
       <c:if test="${waterLitterForm.store!=null && updateWaterLitterForm!=null}">
      <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">To Add Water Litters for Store-Id ${waterLitterForm.store.storeId}</h3>
            </div>
            <div class="box-body">
        <form:form action="updateWaterLitterPath" 
         modelAttribute="updateWaterLitterForm"  method="POST"  >  
           <form:input type="hidden" value="${waterLitterForm.store.storeId}" path="storeId" id="storeId" name="storeId" /> 
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                   <i class="glyphicon glyphicon-qrcode"></i>
                    ...
                    <form:input type="text"  class="form-control" value="s-${waterLitterForm.store.storeId}" path="storeId" name="storeId" id="storeId" disabled="true"/>
                 
                </div>
                <!-- /.input group -->
              </div>   
           <div class="form-group">
                <label>Water Litter :</label>
                  ...
                  <div class="input-group-addon">
                   <i class="glyphicon glyphicon-tint"></i>
                    ...
                    <form:input type="text"  class="form-control" 
                     id="waterLitter" name="waterLitter" path="waterLitter" 
                     placeholder="Enter Water Litter" required="required"/>
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="text"  class="form-control" value="${waterLitterForm.store.totalLitter}" 
                      disabled="true"/>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="text"  class="form-control" value="${waterLitterForm.store.totalPound}" 
                     disabled="true"/>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">To  Add Water Litter</h4>
              </div>
              <div class="modal-body">
                 <p>
		<h3> Add water Litter For Customer Id :(${waterLitterForm.customer.customerId})
		 ${myForm.customer.name}  </h3>
		 Store Id : s-${waterLitterForm.store.storeId}<br>
		 Total Litter :${waterLitterForm.store.totalLitter} Litter<br>
		 Total Pound :${waterLitterForm.store.totalPound} lb<br>
		 </p>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <input type="submit" class="btn btn-outline" value="Are you sure to Add?">
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
     ...
     <div class="box box-info">
         <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">To Add Water Litters For Customer Id(${waterLitterForm.customer.customerId})  ${waterLitterForm.customer.name}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover dataTable js-exportable">
                ...
                <tbody>
                 <c:forEach var="store" items="${waterLitterForm.stores}" varStatus="s">
                <tr>
                
                 <td>${s.index+1 }</td>
                 <td>s-${store.storeId }</td>
                 <td>${store.totalPound}  lb</td>
                 <td>${store.totalLitter }</td>
