 ...
 <%@ include file="/assets/template/header/CustomerRegisterHeader.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
   To  ${waterLitterForm.address.address} Customers
        <small>Add Water Litter</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Customer Table</a></li>
        <li class="active">To Add ${waterLitterForm.address.address} Customers Water Litter</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">View All ${waterLitterForm.address.address} Customers</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                 <c:forEach var="c" items="${waterLitterForm.customers}" varStatus="s">
                <tr>
               ...
               <c:if test="${c.male=='m'}">U ${c.name }
                 ...
                 <td><a  class="btn btn-small btn-danger btn-xs" href="toInsertWaterLitterPath?customerId=${c.customerId}">Add Water Litter 
                 <i class="glyphicon glyphicon-tint"></i></a></td>
